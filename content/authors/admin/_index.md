...
Our lab studies the cognitive and brain underpinnings of *episodic memory*&mdash;a type of memory that allows people to encode and remember the events of their daily lives. We combine methods from experimental psychology with neuroimaging techniques such as functional magnetic resonance imaging (fMRI) and electroencephalography (EEG). Our approach of investigating normal neurocognitive function in healthy young adults has the ultimate goal of understanding how memory is impaired by brain injury, developmental disorders, neurological disease, and natural aging.
